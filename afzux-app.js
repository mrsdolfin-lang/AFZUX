...
function AFZUXApp(){
  ...
  var s60=useState({hfToken:'',orKey:'',geminiKey:'',claudeKey:'',openaiKey:'',grokKey:''}); var aiKeys=s60[0]; var setAiKeys=s60[1];
  // Generate tab
  ...
  return h('div',{style:{minHeight:'100vh',background:BG,color:TEXT}},
    ...
    h('div',{style:{padding:'14px',maxWidth:'760px',margin:'0 auto'}},
      ...
      tab==='aikeys' && h('div',null,
        ...
        ['hfToken','orKey','geminiKey','claudeKey','openaiKey','grokKey'].map(function(key){
          var labels={hfToken:'HuggingFace Token',orKey:'OpenRouter Key',geminiKey:'Gemini Key',claudeKey:'Claude (Anthropic) Key',openaiKey:'OpenAI Key',grokKey:'Grok Key'};
          var links={hfToken:'huggingface.co/settings/tokens',orKey:'openrouter.ai/keys',geminiKey:'aistudio.google.com',claudeKey:'console.anthropic.com',openaiKey:'platform.openai.com',grokKey:'console.x.ai'};
