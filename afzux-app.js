...
function AFZUXApp() {
  ...
  const S = {
    inp:(x={})=>({background:"var(--card)",border:"1.5px solid var(--border)",borderRadius:"10px",padding:"10px 14px",color:"var(--text)",fontSize:"13px",fontFamily:"var(--font)",width:"100%",boxSizing:"border-box",outline:"none",...x}) btnGold:(x={})=>({padding:"11px 18px",borderRadius:"10px",border:"none",background:"var(--gradGold)",color:"#1A1000",fontWeight:700,fontSize:"13px",cursor:"pointer",fontFamily:"var(--font)",boxShadow:"var(--shadowGold)",...x}),
    btnGhost:(x={})=>({padding:"7px 12px",borderRadius:"9px",border:"1px solid var(--border)",background:"transparent",color:"var(--sub)",fontSize:"12px",cursor:"pointer",fontFamily:"var(--font)",...x}) card:(x={})=>({background:"var(--card)",border:"1px solid var(--border)",borderRadius:"14px",padding:"16px",...x}),
