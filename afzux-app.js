    ...
    h('div',{style:{padding:'14px',maxWidth:'760px',margin:'0 auto'}},
      ...
      tab==='aikeys' && h('div',null,
        ...
        h('div',{style:{background:CARD,border:'1px solid '+BORDER,borderRadius:'14px',padding:'16px',marginBottom:'14px'}},
          ...
          (aiKeys.groqKeys||['']).map(function(k,i){
            return h('div',{key:'gk'+i,style:{display:'flex',gap:'8px',marginBottom:'8px'}},
              h('input',{type:'password',value:k,
                onChange:function(e){var nk=Object.assign({},aiKeys);var arr=(nk.groqKeys||['']).slice();arr[i]=e.target.value;nk.groqKeys=arr;setAiKeys(nk);},
                placeholder:'gsk_...',
          ...
          h('div',{style:{fontSize:'11px',color:GREEN}},'\u2705 '+((aiKeys.groqKeys||[]).filter(function(k){return k.trim();}).length)+' active key(s)')
        ),
        ...
        h('div',{style:{background:CARD,border:'1px solid '+BORDER,borderRadius:'14px',padding:'16px',marginBottom:'14px'}},
          ...
          (aiKeys.orKeys||['']).map(function(k,i){
            return h('div',{key:'ok'+i,style:{display:'flex',gap:'8px',marginBottom:'8px'}},
              h('input',{type:'password',value:k,
                onChange:function(e){var nk=Object.assign({},aiKeys);var arr=(nk.orKeys||['']).slice();arr[i]=e.target.value;nk.orKeys=arr;setAiKeys(nk);},
          ...
          h('div',{style:{fontSize:'11px',color:GREEN}},'\u2705 '+((aiKeys.orKeys||[]).filter(function(k){return k.trim();}).length)+' active key(s)')
        ),
        ...
        },style:{width:'100%',padding:'12px',background:GOLD,color:'#000',border:'none',borderRadius:'12px',cursor:'pointer',fontWeight:700,fontSize:'14px',fontFamily:'inherit'}},'\ud83d\udcbe Save All Keys')
      ),
